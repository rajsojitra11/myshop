    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header">{{ $lowStockCount }} Low Stock Products</span>
          <div class="dropdown-divider"></div>
          @forelse(\App\Models\Product::lowStock()->get() as $product)
            <a href="{{ route('product.index') }}" class="dropdown-item">
              <i class="fas fa-box mr-2 text-warning"></i>
              <div>
                <strong>{{ $product->name }}</strong>
                <p class="text-sm text-muted mb-0">Available: {{ $product->available_quantity }} units (Total Stock: {{ $product->stock_quantity }})</p>
              </div>
            </a>
            <div class="dropdown-divider"></div>
          @empty
            <span class="dropdown-item text-center text-success">All products have sufficient stock</span>
          @endforelse
          <a href="{{ route('product.index') }}" class="dropdown-item dropdown-footer">View All Products</a>
        </div>
      </li>
      <li class="nav-item">

...
<head>
    ...
    <title>Forgot Password - Customer | Myshop</title>
    ...
    <div class="login-container" style="max-width: 480px;">
        <div class="login-form" style="padding-left: 0; width: 100%;">
            ...
            <p class="forgot-subtitle">
                Enter the email address from your invoice. We'll send an OTP to recover your login credentials.
            </p>

            <div class="info-box">
                💡 Your password is your <strong>mobile number</strong> from your invoice. We'll help you recover it.
            </div>
            ...
            <form action="{{ route('customer.password.send-otp') }}" method="POST">
                @csrf
                <div class="input-group">
                    <label for="email">Email Address (from your invoice)</label>
                    <input
                        type="email"
                        id="email"
                        name="email"
